...
<?php if (!empty($user) && $user['type'] == 1) : ?>
  ...
  <head>
    ...
    <title>Administrar Curiosidades</title>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Administrar Curiosidades</h1>
          <center><h2><?php echo $user['name']; ?>, estas son las curiosidades que han hecho.</h2><center>
        </div>
      </div>
      ...
      <tbody>
        ...
        while ($results = $records->fetch(PDO::FETCH_ASSOC)) { ?>
          <tr>
            ...
            <td>
              <a href='modificar_noticiasAdmin.php?id=<?php echo $results['id']; ?>'><button type='button' class="btn btn-success">Modificar</a>
              <a href="eliminar_noticia.php?id=<?php echo $results['id']; ?>"><button type='button' class="btn btn-danger">Eliminar</a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
