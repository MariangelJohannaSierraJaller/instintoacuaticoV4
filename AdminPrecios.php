      ...
      <tbody>
        ...
        while ($results = $records->fetch(PDO::FETCH_ASSOC)) { ?>
          <tr>
            ...
            <td>
              <a href='modificar_precio.php?id=<?php echo $results['id']; ?>'><button type='button' class="btn btn-success">Modificar</a>
              <a href="eliminar_precio.php?id=<?php echo $results['id']; ?>"><button type='button' class="btn btn-danger">Eliminar</a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
